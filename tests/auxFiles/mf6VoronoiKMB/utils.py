...
import os, shutil, time, json, gzip # KMB
from pathlib import Path
import io
import fiona
import dask_geopandas as dgpd # KMB, could add a check to see if installed
import numpy as np
...
def processVertexFilterCloseLimit_df(layerRef,layer_geoms,modelDis,use_dask=False,nproc=10):
